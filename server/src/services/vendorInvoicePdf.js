...
export const buildVendorInvoicePdf = async (invoice, options = {}) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (invoice.terms && footerY < 748) {
      doc.font("Helvetica").fontSize(8).fillColor("#8b97b3").text(`Terms: ${invoice.terms}`, 46, footerY, { width: 498, lineBreak: false, ellipsis: true, height: 20 });
    } else if (settings.invoiceTerms) {
