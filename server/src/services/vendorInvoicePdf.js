...
export const buildVendorInvoicePdf = async (invoice, options = {}) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    if (invoice.terms && footerY < 760) {
      doc.font("Helvetica").fontSize(8).fillColor("#8b97b3").text(`Terms: ${invoice.terms}`, 46, footerY, { width: 498 });
    } else if (settings.invoiceTerms && footerY < 760) {
